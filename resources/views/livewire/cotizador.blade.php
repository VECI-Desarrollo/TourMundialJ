                    ...
                    <div class="row g-3">
                       ...
                       <div wire:loading>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div  id="menuDesp" class="mt-2" style="max-height: 200px; overflow-y: scroll; background-color: white;">
                                @foreach($agenciasPagadoras as $agenciaPagadora)
                                    <div wire:click="seleccionarAgenciaPagadora('{{ $agenciaPagadora->nombre }}')"
                                         style="padding: 5px; transition: background-color 0.3s ease;">{{ $agenciaPagadora->nombre }}</div>
                                @endforeach
                            </div>
                            @endif
                        </div>
