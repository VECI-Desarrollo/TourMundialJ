        ...
        <div class="table-responsive">
            <div class="table-wrapper">
              ...
              <tr>
                ...
                <td>    <a href="#" class="delete" onclick="confirm('¿Seguro que quieres eliminar imagen?') || event.stopImmediatePropagation()"   wire:click="delete('{{$registro->id }}')"  title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a></td>
