<div style="margin-top:70px;">
            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <h2 class="text-center">Tipos de <b>monedas</b></h2>
                        </div>
                        <div class="col-sm-4">
                ...
                <button type="button"  class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#agregarTipoMonedaModal">
                    Agregar Moneda
                   </button>
    ...
    <livewire:modales.agregar-tipo-moneda/>
