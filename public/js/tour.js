$.fn.PageTour = function (opts) {
  ...
  function __init() {
    ...
    elements.tour
      .css({ display : 'none', top : 0, left : 0,  'z-index': 50 })
      .append(
        elements.overlay,
        elements.title,
        elements.description,
  ...
  function shadowElement() {
    elements.shadow.css({
      ...
      'z-index': 50 // Agregamos el z-index aquí
    });
  }
...
////// seccion para modificar los estilos de titutlo, 
  function setupStyle() {
    var styleSheet = '';
    var styles = {
      'overlay' : {
      ...
      'title' : {
        ...
        style : 'top: 0; left: 0; text-shadow: 0 0 10px #aaa; color: white; font-size: 2em; position: absolute; font-weight: bold !important; width: 20rem; z-index: 50;'
      },
      'description' : {////// para las descripciones en general estilos
        selector : '.' + _o.prefix + '_description',
        style : 'top: 0; left: 0; box-shadow: 0 0 7px #666; border-radius: 7px; padding: 11px; color: white; font-size: 20px; position: absolute; width: 35rem; font-weight: normal !important; z-index: 50;'
      },
      'controls' : {
      ...
      'targets' : {
        ...
        style : 'top: 0; left: 0; border-radius: 50%; border: 1px solid #333; position: absolute; opacity: 0.3; z-index: 50;'
      },
      'target_large' : {
